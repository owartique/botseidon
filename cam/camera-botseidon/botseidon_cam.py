...
compass_id = 17 #aruco marker id of the compass
MarkerLenght =10 #size of the marker 


# calibration matrix/coef
...
while True:
    ...
    if ids is not None:
        ...
        for i in (0, len(ids)-1):
            ...
            if(ids[i]==beacon_id): #if the id of the marker is the beacon_id
