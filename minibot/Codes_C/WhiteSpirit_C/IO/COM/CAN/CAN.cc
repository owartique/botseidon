...
bool CAN::decipher_msg(CANMessage *msg)
{
...
void CAN::ctrl_motor(int state)
{
	...
	msg.rtr = 0;
	msg.priority = 3;
	msg.data[0] = 0x1E; // registre des GPIO
	msg.data[1] = 0x30; // masque 00110000
	msg.data[2] = state? 0x00: 0xFF; // 11111111 AND 00110000 ce qui met le brake (GPIO4 et GPIO5)
	msg.len = 3;
	msg.sid = CAN_MOT;
...
void CAN::ctrl_led(int state)
{
    ...
    msg.priority = 3;
    msg.data[0] = 0x1E; // registre des GPIO
    msg.data[1] = 0x40; // le masque ??
    msg.data[2] = state? 0x40 : 0x0; // on ecrit 01000000 ou pas pour allumer ou pas la led
